...
impl Plugin for FoodPlugin {
    fn build(&self, app: &mut App) {
        let food_spawn_timer = FoodSpawnTimer(Timer::from_seconds(FOOD_SPAWN_INTERVAL, TimerMode::Repeating));
...
fn spawn_foods(
    ...
    commands.spawn((Food { energy: 80. }, Transform::from_xyz(x as f32, y as f32, 0.0), sprite));
}
